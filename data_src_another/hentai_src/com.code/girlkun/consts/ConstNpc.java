...
public class ConstNpc {
    ...
    public static final String TU_TIEN=  "Chào con ta nghe nói ở nơi vực sâu khô cằn sỏi đá \n Có chứa 1 lượng lớn kho báu vĩ đại \n hãy đến các khu vực phí đông wibu NAPA < FITRE  ' thu thập đá Tu tiên \n TA SẼ GIÚP CON CÓ MỘT SỨC MẠNH PHI THƯỜNG \n HƯỚNG DẪN TU TIÊN : \n CẤP 1 đến 10 199 đá tu tiên ' + 10k tc ,100k hp' \n CẤP 10 - 20 599 đá tu tiên + 15k  tc , 150k hp \n CẤP 20 - 30 999 đá tu tiên + 20k tc , 220k hp ki \n KHI TU TIÊN  ĐẾN CẤP 15 NHẬN ĐƯỢC 1 DANH HIỆU BẤT BẠI , \n CẤP 30  NHẬN DDUOJC DANH HIỆU TRÙM CUỐI 'tự mặc'\n -------------------------------------<<<<>>>-----------------------------------";
    //npcid
    ...
    public static final byte isekai = 86;   
    ...
    public static final byte TRONG_TAI = 22;
     public static final byte DE_TU = 79;
    ...
    public static final byte BONG = 93;
    ...
    public static final int SUKIENHALO = 50888;
     public static final int đoianhhieu = 50889;
    public static final byte MR_POPO = 67;
    public static final byte PANCHY = 68;
    public static final byte THO_DAI_CA = 69;
     public static final byte BA_DOC = 70;
    ...
    public static final byte Bery= 71;
    public static final byte TUTIEN= 100;
    public static final byte CHIHANG= 78;
    public static final byte MBANK= 80;
     public static final byte CHIDAI= 81;
    public static final byte kami2= 87;  
    ...
    public static final int MENU_OPENED_GAS = 540;
     ...
     public static final int MENU_ACCPET_GO_TO_MBANK = 541;
    public static final int MENU_OPEN_MBANK = 542;
    public static final int MENU_OPENED_MBANK = 543;
...
//    public static final int CONFIRM_ACTIVE = 518;
    ...
    public static final int MENU_OPTION_USE_ITEM736 = 1990;
    public static final int MENU_OPTION_USE_ITEM1105 = 1105;
    public static final int MENU_OPTION_USE_ITEM1989 = 1989;
    ...
    public static final int loginok = 528;     
