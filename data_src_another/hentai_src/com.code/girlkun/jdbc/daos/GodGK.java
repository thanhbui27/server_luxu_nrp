...
//                }else
                ...
                if (rs.getBoolean("ban")) {
                    Service.gI().sendThongBaoOK(session, "server bắt đầu thu phí 20k mỗi tháng nhé đóng tiền điện \n tất cả mọi vật phẩm vàng vnd điều free hiết nhé  zalo 0364854825!");
              //  NpcService.gI().createMenuConMeo(player, ConstNpc.loginok, -1, "Quyền năng Thiên Sứ ",
               //         "kick hoat thanh viên");
                        //return;                
              //   ConstNpc.loginok
                    ...
                    if (plInGame != null) {
                        ...
                        Service.gI().sendThongBaoOK(session, "Bạn Đang Đăng Nhập Thiết Bị Khác ");
                    } else {
                    }
//                    Service.gI().sendThongBaoOK(session, "Tài khoản đang được đăng nhập tại máy chủ khác");
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            long plHp = 20000000000L;
                            long plMp = 20000000000L;
                         ...
                         //   player.quang = rs.getByte("quang");
                            ...
                            int timeMaydosc = Integer.parseInt(String.valueOf(dataArray.get(2)));  
                            int timeCuongNo = Integer.parseInt(String.valueOf(dataArray.get(3)));
                            int timeMayDo = Integer.parseInt(String.valueOf(dataArray.get(4)));
                            int timeMeal = Integer.parseInt(String.valueOf(dataArray.get(5)));
                            int timeChimUng = Integer.parseInt(String.valueOf(dataArray.get(6)));
                            int iconMeal = Integer.parseInt(String.valueOf(dataArray.get(7)));
                            int timeXimuoi = Integer.parseInt(String.valueOf(dataArray.get(8)));
                            int timeUseTDLT = 0;
                            ...
                            player.itemTime.lastTimeUseChimUng = System.currentTimeMillis() - (ItemTime.TIME_CHIM_UNG - timeChimUng);
                            player.itemTime.lastTimeXimuoi = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeXimuoi);
                            ...
                            player.itemTime.isUseChimUng = timeChimUng != 0;
                            player.itemTime.isUseXimuoi = timeXimuoi != 0;
                            ...
                            if (!petData.isEmpty()) {
                                ...
                                long hp = Integer.parseInt(String.valueOf(dataArray.get(10)));
                                long mp = Integer.parseInt(String.valueOf(dataArray.get(11)));
    ...
    public static Player loadById(int id) {
        ...
        try {
            ...
            if (rs.first()) {
                ...
                int timeMaydosc = Integer.parseInt(String.valueOf(dataArray.get(2)));
                int timeCuongNo = Integer.parseInt(String.valueOf(dataArray.get(3)));
                int timeChimUng = Integer.parseInt(String.valueOf(dataArray.get(4)));
                int timeMayDo = Integer.parseInt(String.valueOf(dataArray.get(5)));
                int timeMeal = Integer.parseInt(String.valueOf(dataArray.get(6)));
                int iconMeal = Integer.parseInt(String.valueOf(dataArray.get(7)));
                int timeXimuoi = Integer.parseInt(String.valueOf(dataArray.get(8)));
                player.itemTime.lastTimeBoHuyet = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeBoHuyet);
                player.itemTime.lastTimeBoKhi = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeBoKhi);
