...
public final class MobMe extends Mob {
    ...
    public MobMe(Player player) {
        ...
        this.point.maxHp = SkillUtil.getHPMobMe(Util.NHuyHauGH(player.nPoint.hpMax), level);
        this.point.dame = SkillUtil.getHPMobMe(Util.NHuyHauGH(player.nPoint.getDameAttack(false)), level);
