...
public class NPoint {
    ...
    private void setHpHoi() {
        this.hpHoi = Util.NHuyHauGH(this.hpMax / 100);
    ...
    private void setMpHoi() {
        this.mpHoi = Util.NHuyHauGH(this.mpMax / 100);
    ...
    private void setHpMax() {
        ...
        if (this.player.zone != null && MapService.gI().isMapCold(this.player.zone.map)
         ...
         if (this.player.zone != null && MapService.gI().isMapKhiDoc(this.player.zone.map)
                && !this.isKhongDoc) {
            this.hpMax /= 3;
        }
//        if (player.capCS > 0) {
//            if (player.capCS <= 10) {
//                hpMax += (1000) * player.capCS;
//            }
//            if (player.capCS <= 20 && player.capCS > 10) {
//                hpMax +=(1500) * (player.capCS);
//            }
//            if (player.capCS > 20) {
//                hpMax +=(1700) * (player.capCS);
//            }
////        }
//         if (player.capTT > 0) {
//            if (player.capTT <= 10) {
//                hpMax += (1700) * player.capTT;
//            }
//            if (player.capTT <= 20 && player.capTT > 10) {
//                hpMax +=(2500) * (player.capTT);
//            }
//            if (player.capTT > 20) {
//                hpMax +=(3200) * (player.capTT);
//            }
//        }
    ...
    private void setMpMax() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.mpMax += ((long) this.mpMax * 100 / 100);//MP berus
        }
         if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.mpMax += ((long) this.mpMax * 2);//MP berus
        }
        //hợp thể
...
//           }
    ...
    private void setDame() {
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseXimuoi) {
            this.dame += this.dame *= 1;
        }
        //giảm dame
...
//                int dameX4 =  player.inventory.getParam(player.inventory.itemsBody.get(5), 159);
 ...
 //               }
            ...
            case Skill.DICH_CHUYEN_TUC_THOI:
                dameAttack *= 2;
                dameAttack = Util.NHuyHaunext(dameAttack - (dameAttack * 5 / 100),
        ...
        if (percentDameSkill != 0) {
            long dametemp = dameAttack * percentDameSkill / 100;
            dameAttack =  dametemp;
        }
        ...
        dameAttack = Util.NHuyHaunext(dameAttack - (dameAttack * 5 / 100), dameAttack + (dameAttack * 5 / 100));
        if (player.isPl()) {
    ...
    public long getPowerLimit() {
        switch (limitPower) {
            ...
            case 9:
                return 1200999999999L;
            case 10:
                return 1300999999999L;
            case 11:
                return 1400999999999L;
            case 12:
                return 1500999999999L;
            case 13:
                return 1600999999999L;
            case 14:
                return 1700999999999L;
            case 15:
