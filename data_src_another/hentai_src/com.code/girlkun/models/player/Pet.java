...
public class Pet extends Player {
    ...
    private String getTextStatus(byte status) {
        switch (status) {
            ...
            case ATTACK:
                return "Ok sư phụ, Súc Vật Này, Đụng Thì Chạm";
            case GOHOME:
                return "Ok con về, Good Bye";
            default:
                return "";
        }
    }
                ...
                case GOHOME:
                    if (this.zone != null && (this.zone.map.mapId == 21 || this.zone.map.mapId == 22 || this.zone.map.mapId == 23)) {
                        if (System.currentTimeMillis() - lastTimeMoveAtHome <= 5000) {
                            ...
                            Service.gI().chatJustForMe(master, this, "Cảm Ơn Sư Phụ");
...
//                short point = (short) Util.nextInt(1,3);
