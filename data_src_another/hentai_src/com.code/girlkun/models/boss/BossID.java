...
public class BossID {
    ...
    public static final int TRUNG_UY_TRANG = -4999;
    public static final int TRUNG_UY_THEP = -5999;
    public static final int TRUNG_UY_XANH_LO = -6999;
    public static final int NINJA_AO_TIM = -7999;
    public static final int ROBOT_VE_SI = -8999;
    
    public static final int NINJA_AO_TIM1 = -9999;
    public static final int NINJA_AO_TIM2 = -10999;
    public static final int NINJA_AO_TIM3 = -11999;
    public static final int NINJA_AO_TIM4 = -12999;
...
//   
    ...
    public static final int FIDE = -28;
     ...
     public static final int DARK = -300;
    ...
    public static final int LUNA = -230;
    ...
    public static final int GOJO = -254;
    ...
    public static final int BAIBIEN = -299;
    ...
    public static final int NGOKHONGNM = -320;
    public static final int NGOKHONGXD = -321;
    public static final int NGOKHONGTD = -322;
    
    public static final int QUAITHU = -323;
    public static final int THO = -324;
    public static final int THO1 = -325;
    public static final int THO2 = -326;
    public static final int THO3 = -327;
