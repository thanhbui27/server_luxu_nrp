...
// BOSS NV DARK
      ...
      public static final BossData DARK1 = new BossData(
            "DARK ONE", //name
            ConstPlayer.XAYDA, //gender
            new short[]{183, 184, 185, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            32000000, //dame
            new long[]{1500000000L}, //hp
            new int[]{28,31,36}, //map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_GALICK), //skill
            new String[]{"|-1|Khá lắm con trai, dám phá tan giấc mộng của ta...",
                    "|-1|Ta không thấy đám Ginyu đâu,... các ngươi đã giết chúng rồi à?",
                    "|-1|Tuy không biết các ngươi dùng quỷ kế gì, nhưng ta rất ấn tượng đấy!",
    ...
    public static final BossData DARK2 = new BossData(
            "DARK 2", //name
            ConstPlayer.XAYDA, //gender
            new short[]{186, 187, 188, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            5000000, //dame
            new long[]{2300000000L}, //hp
            new int[]{28,31,36}, //map join
            (int[][]) Util.addArray(FULL_ANTOMIC,FULL_LIENHOAN), //skill
            new String[]{"|-1|Hê hê, cẩn thận đi",
                    "|-1|Nếu đã biến thành thế này thì ta sẽ không nhùn nhặn như trước đâu"
    ...
    public static final BossData DARK3 = new BossData(
            "DARK 3", //name
            ConstPlayer.XAYDA, //gender
            new short[]{189, 190, 191, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1220000, //dame
            new long[]{2100000000L}, //hp
            new int[]{28,31,36}, //map join
            (int[][]) Util.addArray(FULL_MASENKO,FULL_LIENHOAN), //skill
            new String[]{"|-1|Ta sẽ cho các ngươi thấy đâu mới là sức mạnh của ta!!"}, //text chat 1
            new String[]{"|-1|Ta nói các ngươi rồi! Sức mạnh này của ta còn đáng sợ hơn địa ngục!!",
...
//            TypeAppear.ANOTHER_LEVEL
    ...
    public static final BossData CUMBER = new BossData(
            " Drabu Supper", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1248, 1249, 1250, -1, 0, -1}, //outfit {head, body, leg, bag, aura, eff}
            200000, //dame
    ...
    public static final BossData XEN_CON = new BossData(
            ...
            new String[]{"|-2|Đêm qua em đẹp lắm!"}, //text chat 3
            REST_15_M,
             new int[]{BossID.CUMBER}//second rest
    );
    //**************************************************************************
...
//            new int[]{14},
    ...
    //**************************************************************************
 public static final BossData NGOKHONGNM = new BossData(
            "Mỹ Hầu 1", //name
            ConstPlayer.XAYDA, //gender
            new short[]{461, 458, 459, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1111111, //dame
            new long[]{1200000000L}, //hp
            new int[]{175,176,177}, //map join
            new int[][]{
                    {Skill.GALICK, 7, 10000},
                    {Skill.KAMEJOKO, 7, 10000},
                  //  {Skill.BIEN_KHI, 1, 600000},
    ...
    public static final BossData NGOKHONGXD = new BossData(
            "Mỹ hầu 2", //name
            ConstPlayer.XAYDA, //gender
            new short[]{460, 458, 459, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            11101110, //dame
    ...
    public static final BossData NGOKHONGTD = new BossData(
            "Mỹ hầu",
            ConstPlayer.XAYDA,
            new short[]{457, 458, 459, -1, -1, -1},
            1000000,
            new long[]{1020000000L},
            new int[]{175,176,177},
//            new int[]{14},
            new int[][]{
            ...
            new String[]{"|-2|Á đù, THẠCH HẦU !!!!!"}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            REST_15_M, //second rest
            new int[]{BossID.NGOKHONGXD, BossID.NGOKHONGNM} //boss join map together
    );
...
//            new int[]{14}, //map join
    ...
    //*******************
    //**************************************************************************
     public static final BossData LUNA = new BossData(
            "Boss Đệ wibu",
            ConstPlayer.XAYDA,
            new short[]{906, 925, 904, -1, -1, -1},
            50000,
            ...
            //       {Skill.BIEN_KHI, 7, 100000}, //skill
                  ...
                  //  {Skill.TAI_TAO_NANG_LUONG, 7, 100000},
                    {Skill.SOCOLA, 7, 1000}},
            new String[]{"|-2|Đệ KAMI đã xuất hiện rồi"}, //text chat 1
            new String[]{"|-1|Giết ta ngươi se  có đệ WIBU!"}, //text chat 2
            new String[]{"|-1|Nhớ mặt tao đấy",
                    "|-1|Tobe continue.."}, //text chat 3
            REST_15_M
    );
    ...
    public static final BossData YACON = new BossData(
          ...
          public static final BossData GOJO = new BossData(
            "GOJO linh thú",
            ConstPlayer.XAYDA,
            new short[]{1216,1217,1218, -1, -1, -1},
            200000,
            ...
            new int[][]{
                    {Skill.DEMON, 7, 100},
                    {Skill.DE_TRUNG, 7, 1000},
                    {Skill.LIEN_HOAN, 5, 4000},
                    // {Skill.BIEN_KHI, 7, 10000}
            },
            new String[]{"|-2|GOJOđã xuất hiện rồi"}, //text chat 1
            new String[]{"|-1|Thấy ảo chưa nè!"}, //text chat 2
            new String[]{"|-1|Nhớ mặt tao đấy",
                    "|-1|Tobe continue.."}, //text chat 3
            REST_10_M
    );
            public static final BossData BAIBIEN = new BossData(
            "Androi Mùa Hè",
            ConstPlayer.XAYDA,
            new short[]{1650,1651,1652, -1, -1, -1},
            200000,
            new long[]{2015000000L},
            new int[]{174},
            new int[][]{
                    {Skill.DEMON, 7, 100},
                    {Skill.DE_TRUNG, 7, 1000},
            ...
            new String[]{"|-2|ANDROI BÃI biển đã xuất hiện rồi"}, //text chat 1
            new String[]{"|-1|Thấy ảo chưa nè!"}, //text chat 2
            new String[]{"|-1|Nhớ mặt tao đấy",
                    "|-1|Tobe continue.."}, //text chat 3
            REST_10_M
    );
             public static final BossData QUAITHU = new BossData(
            " QUÁI THÚ LV100 ",
            ConstPlayer.XAYDA,
            ...
            new String[]{"|-2|Quái Thú đã xuất hiện"}, //text chat 1
            new String[]{"|-1|Thấy ảo chưa nè!"}, //text chat 2
            new String[]{"|-1|Nhớ mặt tao đấy",
                    "|-1|Tobe continue.."}, //text chat 3
            REST_10_M
    );
             public static final BossData THO = new BossData(
            "Thỏ Trắng Cute",
            ConstPlayer.XAYDA,
            new short[]{885,886,887, -1, -1, -1},
            200000,
            new long[]{150000000L},
            new int[]{1,8,15,29,37,33},
            new int[][]{
                    {Skill.DEMON, 7, 100},
                  //  {Skill.TAI_TAO_NANG_LUONG, 7, 1000},
                    {Skill.LIEN_HOAN, 5, 4000},
            ...
            new String[]{"|-2|KI KI < Thỏ trắng đây"}, //text chat 1
            new String[]{"|-1|Thấy ảo chưa nè!"}, //text chat 2
            new String[]{"|-1|Nhớ mặt tao đấy",
                    "|-1|aAAAAAA đồ ngon đồ ngon.."}, //text chat 3
            REST_5_M
    );
               public static final BossData THO1 = new BossData(
            "Thỏ Trắng Cute",
            ConstPlayer.XAYDA,
            new short[]{885,886,887, -1, -1, -1},
            200000,
            ...
            REST_5_M
                 ...
                 public static final BossData THO2 = new BossData(
            "Thỏ Trắng Cute",
            ConstPlayer.XAYDA,
            new short[]{885,886,887, -1, -1, -1},
            200000,
            ...
            REST_5_M
                   ...
                   public static final BossData THO3 = new BossData(
            "Thỏ Trắng Cute",
            ConstPlayer.XAYDA,
            new short[]{885,886,887, -1, -1, -1},
            200000,
