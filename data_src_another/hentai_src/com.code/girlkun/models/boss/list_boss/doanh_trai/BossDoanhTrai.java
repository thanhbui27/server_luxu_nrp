...
public class BossDoanhTrai extends Boss {
    ...
    public BossDoanhTrai(DoanhTrai doanhTrai, long xHp, long xDame, int id, BossData... data) throws Exception {
        super(id, data);
    ...
    public void initBase() {
        ...
        this.nPoint.hpg = (long) (totalDame * xHp);
        this.nPoint.dameg = (long) (totalHp / xDame);
