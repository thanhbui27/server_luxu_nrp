...
public class SuperBlack2 extends Boss {
   ...
   public void reward(Player plKill) {
             if (Util.isTrue(35, 50)) {
                ...
                Service.gI().dropItemMap(this.zone, Util.ratiItem(zone, 457, 1, this.location.x -50, this.location.y, plKill.id));
                Service.gI().dropItemMap(this.zone, Util.ratiItem(zone, 457, 1, this.location.x -60 , this.location.y, plKill.id));
                Service.gI().dropItemMap(this.zone, Util.ratiDTL(zone, 565, 1, this.location.x -80, this.location.y, plKill.id));
                Service.gI().dropItemMap(this.zone, Util.ratiDTL(zone, 566, 1, this.location.x-20, this.location.y, plKill.id));
