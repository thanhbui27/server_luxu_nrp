...
import com.girlkun.models.boss.list_boss.Luna;
...
import com.girlkun.models.boss.list_boss.xbh.SieuBoHung;
...
import com.girlkun.models.boss.list_boss.Baibien;
...
import com.girlkun.models.boss.list_boss.dark.Dark;
...
import com.girlkun.models.boss.list_boss.Ngokhong.Ngokhongnm;
import com.girlkun.models.boss.list_boss.Ngokhong.Ngokhongxd;
import com.girlkun.models.boss.list_boss.Ngokhong.Ngokhongtd;
import com.girlkun.models.boss.list_boss.thosk.quaithu;
import com.girlkun.models.boss.list_boss.thosk.tho;
import com.girlkun.models.boss.list_boss.thosk.tho1;
import com.girlkun.models.boss.list_boss.thosk.tho2;
import com.girlkun.models.boss.list_boss.thosk.tho3;
...
public class BossManager implements Runnable {
    ...
    public void loadBoss() {
        ...
        try {
            ...
            this.createBoss(BossID.GOJO);
             this.createBoss(BossID.BAIBIEN);
            
             this.createBoss(BossID.NGOKHONGXD);
             this.createBoss(BossID.NGOKHONGNM);
             this.createBoss(BossID.NGOKHONGTD);
           
             this.createBoss(BossID.QUAITHU);
             this.createBoss(BossID.THO);
             this.createBoss(BossID.THO1);
             this.createBoss(BossID.THO2);
             this.createBoss(BossID.THO3);
...
//                    return new SuperAndroid17();
              ...
              //  case BossID.COOLER:
                ...
                case BossID.BAIBIEN:
                    return new Baibien();
                case BossID.NGOKHONGNM:
                    return new Ngokhongnm();
                case BossID.NGOKHONGXD:
                    return new Ngokhongxd();
                case BossID.NGOKHONGTD:
                    return new Ngokhongtd();
                     case BossID.QUAITHU:
                    return new quaithu();
                case BossID.THO:
                    return new tho();
    ...
    public void run() {
        while (ServerManager.isRunning) {
            try {
                ...
                List<Boss> b = new ArrayList<>(bosses);
                for (Boss boss : b) {
                    boss.update();
                }
                Thread.sleep(100);
