...
public class PlayerService {
    ...
    public void sendInfoHp(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.NHuyHauGH(player.nPoint.hp));
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.NHuyHauGH(player.nPoint.mp));
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Logger.logException(PlayerService.class, e);
    ...
    public void sendInfoHpMpMoney(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.NHuyHauGH(player.nPoint.hp));//chp
            msg.writer().writeInt(Util.NHuyHauGH(player.nPoint.mp));//cmp
            msg.writer().writeInt((int)player.inventory.ruby);//ruby
            player.sendMessage(msg);
        } catch (Exception e) {
            Logger.logException(PlayerService.class, e);
        }
