        ...
        if (player.playerTask.sideTask.template != null) {
            if (player.playerTask.sideTask.isDone()) {
                ...
                switch (player.playerTask.sideTask.level) {
                    case ConstTask.EASY:
                        goldReward = Util.nextInt((ConstTask.GOLD_EASY/2), ConstTask.GOLD_EASY);
                        break;
                    case ConstTask.NORMAL:
                        goldReward = Util.nextInt((ConstTask.GOLD_NORMAL/2), ConstTask.GOLD_NORMAL);
                        break;
                    case ConstTask.HARD:
                        goldReward = Util.nextInt((ConstTask.GOLD_HARD/2), ConstTask.GOLD_HARD);
                        break;
                    case ConstTask.VERY_HARD:
                        goldReward = Util.nextInt((ConstTask.GOLD_VERY_HARD/2), ConstTask.GOLD_VERY_HARD);
                        break;
                    case ConstTask.HELL:
                        goldReward = Util.nextInt((ConstTask.GOLD_HELL/2), ConstTask.GOLD_HELL);;
                        break;
                }
