...
public class InventoryServiceNew {
    ...
    private Item putItemBody(Player player, Item item) {
        ...
        if (item.template.type == 35 && !player.isPet && (item.template.id > 1664 && item.template.id < 1671)) {
            Service.gI().sendThongBaoOK(player.isPet ? ((Pet) player).master : player, "Trang bị không phù hợp !");
            return sItem;
        }
        if (item.template.type == 35 && player.isPet && (item.template.id > 1560 && item.template.id < 1561)) {
            Service.gI().sendThongBaoOK(player.isPet ? ((Pet) player).master : player, "Trang bị không phù hợp !");
            return sItem;
        }
        if (item.template.type == 11 && !player.isPet && (item.template.id > 1559 && item.template.id < 1671)) {
            Service.gI().sendThongBaoOK(player.isPet ? ((Pet) player).master : player, "Trang bị không phù hợp !");
            return sItem;
        }
        if (item.template.type == 11 && player.isPet && (item.template.id > 14 && item.template.id < 1559)) {
            Service.gI().sendThongBaoOK(player.isPet ? ((Pet) player).master : player, "Trang bị không phù hợp !");
            return sItem;
        }
        int index = -1;
    ...
    public void itemBagToBody(Player player, int index) {
        ...
        if (item.isNotNullItem()) {
            if (item.template.id > 1554 && item.template.id < 1559) {
            ...
            if (item.template.id > 1203 && item.template.id < 1211) {
                Service.gI().removeTitle(player);
    ...
    public void itemBoxToBodyOrBag(Player player, int index) {
        ...
        if (item.isNotNullItem()) {
            boolean done = false;
            if (item.template.type >= 0 && item.template.type <= 5 || item.template.type == 32 || item.template.type == 17) {
        ...
        if (itemAdd.template.isUpToUp) {
            for (Item it : items) {
                ...
                if (itemAdd.template.id == 457
                        ...
                        || itemAdd.template.id == 1998
                        || itemAdd.template.id == 610
                        || itemAdd.template.type == 14
                        || itemAdd.template.id == 933
                        || itemAdd.template.id == 1203
                        || itemAdd.template.id == 934
                        || itemAdd.template.id == 674
                        || itemAdd.template.id == 1171
                        || itemAdd.template.id == 1172
                        || itemAdd.template.id == 1170
                        || itemAdd.template.id == 697
                        || itemAdd.template.id == 696
                        || itemAdd.template.id == 695
                        || itemAdd.template.id == 1180
                        || itemAdd.template.id == 1066
                        || itemAdd.template.id == 1067
                        || itemAdd.template.id == 1068
                        || itemAdd.template.id == 1069
                        || itemAdd.template.id == 1070
                        || itemAdd.template.id == 1181
                        || itemAdd.template.id == 1182
                        || itemAdd.template.id == 1176
                        || itemAdd.template.id == 1183
                        || itemAdd.template.id == 1994
                        || itemAdd.template.id == 1995
                        || itemAdd.template.id == 1996
                        || itemAdd.template.id == 1992
                        || itemAdd.template.id == 1991
                        || itemAdd.template.id == 1188
                        || itemAdd.template.id == 1187) {
