...
//    private static final int IFOX_BOX = 400;
    ...
    private static final byte PRICE_RUBY = 40;
    private static final int PRICE_GOLD = 70000000;
    ...
    public void openCrackBallUI(Player pl, byte type) {
        ...
        try {
            ...
            msg.writer().writeInt(type == USING_GEM ? PRICE_RUBY : PRICE_GOLD); //price
    ...
    private void openBallByGem(Player player, byte count) {
        ...
        if (player.inventory.ruby < rubyNeed) {
            Service.gI().sendThongBao(player, "Bạn không đủ ngọc hồng để mở");
            return;
        } else {
