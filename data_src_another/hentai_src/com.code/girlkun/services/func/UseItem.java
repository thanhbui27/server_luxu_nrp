...
public class UseItem {
    ...
    public static boolean changePet;
                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 1990:
                            ...
                            break;
                        case 1989:
                            ItemService.gI().openDTSVIP(pl, item);
                            break;
                        case 987:
                        ...
                        case 1120:
                            ...
                            break;
                         case 1984:
                            if ( pl.inventory.gold >= 1000000000000L )
                            {
                            Service.getInstance().sendThongBao(pl, "Đã đạt giới hạn vàng");
                                return;
                            }else{
                            pl.inventory.gold+=1000000000000L;
                        ...
                        case 2028: {
                            if (InventoryServiceNew.gI().getCountEmptyBag(pl) == 0) {
                                ...
                                linhThu.itemOptions.add(new Item.ItemOption(95, Util.nextInt(10, 15)));
                                linhThu.itemOptions.add(new Item.ItemOption(96, Util.nextInt(10, 15)));
                                 linhThu.itemOptions.add(new Item.ItemOption(5, Util.nextInt(1, 5)));
                                  linhThu.itemOptions.add(new Item.ItemOption(14, Util.nextInt(1, 2)));
                            ...
                            if (InventoryServiceNew.gI().getCountEmptyBag(pl) == 0) {
                                ...
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                                Item linhThu = ItemService.gI().createNewItem((short) Util.nextInt(1555, 1558));
                                linhThu.itemOptions.add(new Item.ItemOption(0, Util.nextInt(100, 1000)));
                                linhThu.itemOptions.add(new Item.ItemOption(7, Util.nextInt(1000, 12000)));
                                linhThu.itemOptions.add(new Item.ItemOption(6, Util.nextInt(1000, 12000)));
                                linhThu.itemOptions.add(new Item.ItemOption(30, 1));
                                linhThu.itemOptions.add(new Item.ItemOption(63, Util.nextInt(1, 3)));
                                InventoryServiceNew.gI().addItemBag(pl, linhThu);
                                InventoryServiceNew.gI().sendItemBags(pl);
    ...
    private void useItemTime(Player pl, Item item) {
        switch (item.template.id) {
            ...
            case 667: //sushi
                ...
                break;
            case 1978: //ximuoi
                pl.itemTime.lastTimeXimuoi = System.currentTimeMillis();
                pl.itemTime.isUseXimuoi = true;
                break;
            case 2037: //máy dò đồ
                pl.itemTime.lastTimeUseMaydosc = System.currentTimeMillis();
                pl.itemTime.isUseMaydosc = true;
                break;
            case 1193: //chim ung dò đồ
                pl.itemTime.lastTimeUseChimUng = System.currentTimeMillis();
                pl.itemTime.isUseChimUng = true;
                break;
