            ...
            switch (cmd) {
                case -100:
                    ...
                    if (!player.getSession().actived) {
                        Service.gI().sendThongBao(player, "Vui lòng mở thành viên!");
                        break;
                    }
                    switch (action) {
                        case 0:
                ...
                case -105:
                    ...
                    } else if (player.type == 0 && player.maxTime == 5) {
                        ChangeMapService.gI().changeMap(player, 179, 0, -1, 5);
                    }
                    break;
                case 42:
                ...
                case -86:
                    if (player != null) {
                        if (player.getSession().actived) {
                            ...
                            Service.gI().sendThongBao(player, "Vui lòng mở thành viên để GD!");
                        }
                ...
                case -71:
                    if (player != null) {
                        if (player.getSession().actived) {
                            ...
                            Service.gI().sendThongBao(player, "Vui lòng mở thành viên để chat TG !");
                        }
                    }
                    break;
                case -79:
...
//        Service.getInstance().sendThongBaoOK(session, "Vui lòng đăng ký tài khoản tại trang chủ!");
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với ngọc rồng LẬU WIBU CODER BY QUANG KAMI\n"
    ...
    private void sendThongBaoServer(Player player) {
        Service.getInstance().sendThongBaoFromAdmin(player, "|7|CHat tt Để xem thông tin bản thân \n|5| Cần Gì Liên Hệ Zalo 0364854825 Chúc anh Em chơi game vui vẻ..\n\n"
