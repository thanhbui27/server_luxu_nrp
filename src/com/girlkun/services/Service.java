...
import com.girlkun.models.boss.list_boss.DoanhTrai.TrungUyTrang;
...
//                }
            ...
            if (text.equals("admin")) {
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, -1, "\n"
                        + "|7|Số người online: " + Client.gI().getPlayers().size() + "\n"
                   //     + "Sessions: " + GirlkunSessionManager.gI().getSessions().size() + "\n"
                        + "Tổng thread map: " + (ServerManager.gI().threadMap) + "\n"
                        + "|7|Tổng Current thread: " + Thread.activeCount() + "\n"
                        + "|7|Thời Gian Sever Chạy: " + ServerManager.timeStart + "\n",
                        "Ngọc rồng", "Đệ tử", "Bảo trì", "Tìm kiếm\nngười chơi", "Boss","Gửi Đồ", "Đóng");
                return;
//                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, -1, "Menu Admin Ngọc Rồng Online " + "\n" + "Số người online: " + Client.gI().getPlayers().size() + "\n" + "Current thread: " + Thread.activeCount() + "\n" + "Time Starr server: " + ServerManager.timeStart,
...
//                return;
                ...
                if (itemRange.length == 2) {
                    ...
                    Service.getInstance().sendThongBao(player, "không hợp lệ!");
...
//            Send_Info_NV(pl);
    ...
    public void sendThongBaoFromAdmin(Player player, String text) {
        sendBigMessage(player, 10691, text);
    }
...
//            e.printStackTrace();
    ...
    public void sendFoot(Player player, int id) {
        ...
        try {
            ...
            me.writer().writeInt((int) player.id);
            if (id == 2055) {
                me.writer().writeShort(1010);
            } else if (id == 2056) {
                me.writer().writeShort(1011);
            } else if (id == 2057) {
                me.writer().writeShort(1012);
            } else if (id == 2058) {
                me.writer().writeShort(1013);
            } else if (id == 2059) {
                me.writer().writeShort(1014);
            } else if (id == 2060) {
                me.writer().writeShort(1015);
            } else if (id == 2061) {
                me.writer().writeShort(1016);
            } else if (id == 2062) {
                me.writer().writeShort(1017);
            } else if (id == 2063) {
