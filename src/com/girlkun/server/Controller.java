...
import com.girlkun.models.map.GiaiSieuHang.SieuHangService;
...
//                        ChangeMapService.gI().changeMapBySpaceShip(player, 149, -1, 35);
//                        player.iDMark.setGoToKG(false);
                    } else if (player.type == 4 && player.maxTime == 10) {
                        ChangeMapService.gI().changeMapBySpaceShip(player, 141, -1, 238);
                        player.iDMark.setGoToCDRD(false);
                    }
                    break;
                case 42:
                ...
                case -107:
                    ...
                    if (player != null) {
                        try {
                            ...
                            System.out.println("loi tai controller : " + e.getMessage());
                        }
            ...
            try {
                ...
                switch (cmd) {
                    case 0:
                        ...
                        Util.debug("version: " + msg.readUTF());
                        break;
                    case 2:
...
//        Service.gI().switchToRegisterScr(session);
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player, "|7|Chào mừng AE đến với Server Ngọc Rồng Online.\n|0|Chúc AE chơi game vui vẻ...");
    }
