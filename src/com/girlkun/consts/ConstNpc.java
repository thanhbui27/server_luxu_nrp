...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_PHAP_SU_HOA = "Đá pháp sư giúp nâng cấp Trang bị thường  lên Trang bị pháp sư\n Các trang bị có thể nâng cấp bao gồm Cải trang, Pet, Phụ kiện đeo lưng\n Đá pháp sư có thể kiếm bằng cách sử dụng Máy dò đá pháp sư khi tiêu diệt quái ở hành tinh ngục tù\n Trang bị càng nhiều chỉ số pháp sư thì chỉ số càng tăng\n Ngoài ra bùa tẩy pháp sư có thể tẩy các chỉ số khi cần\n Ta chúc các ngươi may mắn";
  ...
  public static final int TANG_HOA = 7842;
    //npcid
    ...
    public static final int MENU_NANG_CAP_CHAN_MENH = 499;
    ...
    public static final int PHAP_SU  = 560;
    public static final int SKH  = 563;
    ...
    public static final int MENU_OPTION_USE_ITEM2093 = 2093;    
    ...
    public static final int MENU_OPTION_USE_ITEM2097 = 2097;
