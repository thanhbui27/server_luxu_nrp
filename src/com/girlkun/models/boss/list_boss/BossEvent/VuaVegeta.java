 ...
 */
public class VuaVegeta extends Boss {
     public VuaVegeta() throws Exception {
        super(BossID.VUAVEGETA, BossesData.VUAVEGETA);
    }
     @Override
    public void reward(Player plKill) {
        int[] listnro = {16,17,18,19,20};
        if (Util.isTrue(30, 100)) {
            Service.gI().dropItemMap(this.zone, Util.caitrangVuaVegeta(zone, 2032, 1, this.location.x, this.location.y, plKill.id, true));        
        } else {
