...
//        it.options.add(new Item.ItemOption(73, 1));
    ...
    public void active() {
        ...
        if (this.playerTarger != null && playerTarger.haveDuongTang && this.zone.map.mapId == this.mapCongDuc) { // xử lý khi đến map muốn đến
            ...
            Item honLinhThu = ItemService.gI().createNewItem((short) (1187));
            int quan = Util.nextInt(5, 10);
            honLinhThu.quantity = quan;
            ...
            Service.getInstance().sendThongBaoOK(playerTarger, "Bạn nhận được 120K hồng ngọc, " + quan + " Đồng bạc !");
            this.leaveMap();
        }
