...
//**************************************************************************
    ...
    public static final BossData VUAVEGETA = new BossData(
            "Vua Vegeta",
            ConstPlayer.XAYDA,
            new short[]{2000, 2001, 2002, -1, -1, -1},
            500000,
            new int[]{1500000000},
            new int[]{17,18,19,20},
            new int[][]{
            ...
            new String[]{"|-2|Tất cả quỳ xuống"}, //text chat 1
            new String[]{"|-1|Ta là vị vua mạnh nhất", "|-1|Các ngươi có biết tên Super Sayan God ở đâu không?",  "|0|Chắc ta phải phá hủy hành tinh này vậy"}, //text chat 2
            new String[]{"|-1|Nhớ mặt tao đấy",
                "|-1|Tobe continue.."}, //text chat 3
            REST_1_M
    );
    ...
    public static final BossData GOKUTAAC = new BossData(
            "Goku Tà Ác",
            ConstPlayer.TRAI_DAT,
            new short[]{2036, 2037, 2038, -1, -1, -1},
            500000,
            new int[]{1500000000},
            new int[]{3,4,5,6},
            new int[][]{
    ...
    public static final BossData THAN_HUY_DIET_CHAMPA = new BossData(
            ...
            ConstPlayer.TRAI_DAT, //gender
            new short[]{511, 512, 513, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            2000000, //dame
            new int[]{1800000000}, //hp
            new int[]{146, 147, 148}, //map join
            new int[][]{
...
public static final BossData BROLY_1 = new BossData(
  ...
  //  );
    ...
    public static final BossData BOSS_BROLY_THUONG = new BossData(
            "Broly", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static final BossData BOSS_BROLY_SUPER = new BossData(
            "Broly Super", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1083, 1084, 1085, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000, //dame
